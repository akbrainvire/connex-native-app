...
const Login = () => {
    ...
    const handleLogin = () => {
        if (state.email !== 'dip@test.com' && state.password !== 'test1234') {
            setErrorMsg({email: 'Please enter valid email', password: 'Please enter valid password'})
        }
    ...
    return (
        <View style={LoginStyle.loginMain}>
            <View style={LoginStyle.topSection}>
                ...
                <Text style={LoginStyle.topDesc}>Please enter your details to login</Text>
            ...
            <View style={LoginStyle.middleSection}>
                <View style={LoginStyle.inputContainer}>
                    ...
                    />
                    {errorMsg?.email != '' && <Text style={LoginStyle.errorMsg}>Please enter valid email</Text>}
                </View>
                <View style={LoginStyle.inputContainer}>
                    ...
                    />
                    {errorMsg?.password != '' && <Text style={LoginStyle.errorMsg}>Please enter valid password</Text>}
                </View>
                <View style={LoginStyle.checkboxDiv}>
                    ...
                    <Text 
                        style={{ textAlign: 'right', textDecorationLine: 'underline', color: '#020024'  }}
            ...
            <View style={LoginStyle.bottomSection}>
                <TouchableOpacity style={{...LandingStyle.btn, backgroundColor: '#020024'}} onPress={() => handleLogin()}>
