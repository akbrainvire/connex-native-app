            ...
            {({
                ...
                <View style={SignUpStyle.signupMain}>
                    <View style={SignUpStyle.topSection}>
                        ...
                        <Text style={SignUpStyle.topDesc}>Please create a login for Connex Reporting</Text>
                    </View>
                    ...
                    <View style={SignUpStyle.bottomSection}>
                        ...
                        <Text style={SignUpStyle.privacyPolicy}>This site is protected by reCAPTCHA and the Google Privacy Policy and Terms of Service apply.</Text>
                    </View>
                </View>
            )}
        </Formik>
